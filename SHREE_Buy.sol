...
contract Buy_SHREE is BEP20, Ownable {
    
    BEP20Interface public SHREE_Token = BEP20Interface(0x405D95F3a4a56743e7e15d866e2F6530ef4b470d);
     
      address  payable  owner_new = 0xf844547532182882e266Ca036f7Ffc2a777e9471 ;
    ...
    function buy_SHREE (uint _tokenAmount) public payable returns (bool) {
      ...
      owner_new.transfer(msg.value);
        ...
        if( buyer != address(0)){
             require(BEP20Interface(SHREE_Token).transferFrom(owner_new,buyer, _tokenAmount));
        }
